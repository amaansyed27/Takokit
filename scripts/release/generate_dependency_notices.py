...
def main() -> None:
    ...
    lines = [
        ...
        "",
        "This file records third-party packages used to build or ship the Takokit application.",
        ...
        "- eSpeak NG 1.52.0 (GPL-3.0-or-later plus component notices; macOS package only): https://github.com/espeak-ng/espeak-ng. The package includes its license texts and exact source URL/checksum.",
        "",
        "## Rust dependencies",
        "",
        *markdown_table(rust),
