...
export function CapabilityPinwheel() {
  ...
  function jumpToCapability(index) {
    ...
    window.scrollTo({
      top: sectionTop + range * ((index + 0.12) / CAPABILITIES.length),
      behavior: "smooth",
    });
  }
  ...
  return (
    ...
    >
      <div className="tk-wheel__stage">
          ...
          <div className="tk-wheel__rotor">
            {CAPABILITIES.map((capability, index) => (
              <div
                ...
                key={capability.task}
                style={{
                  "--spoke-angle": `${index * (360 / CAPABILITIES.length)}deg`,
                  "--spoke-counter-angle": `${-index * (360 / CAPABILITIES.length)}deg`,
                }}
              >
        ...
        <div className="tk-wheel__rail" aria-hidden="true"><span /></div>
      </div>
    </section>
  );
}
